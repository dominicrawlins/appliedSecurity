...
def calcIntermediateValue(d, k):
    v = d ^ k
    v = sboxTable[v]
    return v

def hypotheticalPowerConsumption(v):
    powerConsumption = v & 0x01
...
def attack( argc, argv ) :
  numberOfTraces, numberOfSamples, M, C, T = traces_ld("traces.dat")
...
if ( __name__ == '__main__' ) :
  ...
  test = calcIntermediateValue(0x95, 0x00)
  print(hex(test))
  print(hypotheticalPowerConsumption(test))
